...
## 1.1. **Pantalla Categorias**:
    ...
    de estos y se crea un botón para cada categoría encontrada. Usted podrá seleccionar 
    una categoria y ahí elegir un vino de su preferencia para agregar al carrito. Como 
