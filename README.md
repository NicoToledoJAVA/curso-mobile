...
1. **Categorias**: Aqui, a través de fetchear todos los vinos de la BD de firebase, se crea un botón para cada categoría encontrada. Usted podrá seleccionar una categoria y ahí elegir un vino de su preferencia para agregar al carrito.
